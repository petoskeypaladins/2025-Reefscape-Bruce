...
public class DriveSubsystem extends SubsystemBase {
  ...
  public void periodic() {
    ...
    m_odometry.update(
      ...
      RobotContainer.m_Elastic.RobotOrientedPub.set(isFieldOriented);
      RobotContainer.m_Elastic.gyroPub.set(m_gyro.getAngle());
      RobotContainer.m_Elastic.frontLeftDistancePub.set(m_frontLeft.getPosition().distanceMeters);
  }
  ...
  public void slowDrive(double xSpeed, double ySpeed, double rot, boolean fieldRelative) {
    // Convert the commanded speeds into the correct units for the drivetrain
    double xSpeedDelivered = xSpeed*(1 - 0.8* RobotContainer.m_xboxController.getLeftTriggerAxis()) * DriveConstants.kMaxSpeedMetersPerSecond;
    double ySpeedDelivered = ySpeed*(1 - 0.8*RobotContainer.m_xboxController.getLeftTriggerAxis()) * DriveConstants.kMaxSpeedMetersPerSecond;
    double rotDelivered = rot*(1 - 0.8*RobotContainer.m_xboxController.getLeftTriggerAxis()) * DriveConstants.kMaxAngularSpeed;
...
double Heading;
    public void Heading(double Heading) {
      m_gyro.reset();
      m_gyro.setGyroAngle(m_gyro.getRollAxis(), Heading);
    }
